...
public class SignInDialogFingerprintModel extends BaseObservable {
    ...
    public SignInDialogFingerprintModel() {
    }

    public SignInDialogFingerprintModel(String title, String message, String btnYes, String btnNo, int imgDialog) {
        this.title = title;
